...
import type { EditShiftRow } from "@/components/shifts/EditShiftDialog";
import { eachDayInRange, resolveShiftFromApi } from "@/components/shifts/shift-form-utils";

export type ShiftViewMode = "table" | "calendar";
...
export function expandShiftsToOccurrences(
  shifts: EditShiftRow[],
  rangeFrom?: string,
  rangeTo?: string,
): ShiftOccurrence[] {
